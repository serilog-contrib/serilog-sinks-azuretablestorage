...
/// </summary>
/// <remarks>
/// Based on the MongoDB.Driver implementation
/// </remarks>
public readonly struct ObjectId : IComparable<ObjectId>, IEquatable<ObjectId>
{
    ...
    /// <summary>
    /// Performs an implicit conversion from <see cref="System.String"/> to <see cref="ObjectId"/>.
    /// </summary>
    /// <param name="input">The input <see cref="System.String"/>.</param>
    /// <returns>
    /// The result of the conversion.
    /// </returns>
    public static implicit operator ObjectId(string input) => new ObjectId(input);

    /// <summary>
    /// Performs an implicit conversion from <see cref="ObjectId"/> to <see cref="System.String"/>.
    /// </summary>
    /// <param name="input">The input <see cref="ObjectId"/>.</param>
    /// <returns>
    /// The result of the conversion.
    /// </returns>
    public static implicit operator string(ObjectId input) => input.ToString();
    ...
    public static ObjectId Parse(string value)
    {
        ...
        ObjectId objectId;
        if (TryParse(value, out objectId))
            return objectId;
    ...
    public static bool TryParse(string value, out ObjectId objectId)
    {
        ...
        {
            byte[] bytes;
            if (TryParseHexString(value, out bytes))
            {
