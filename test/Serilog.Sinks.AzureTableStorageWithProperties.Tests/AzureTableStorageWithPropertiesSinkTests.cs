...
namespace Serilog.Sinks.AzureTableStorage.Tests
{
	public class AzureTableStorageWithPropertiesSinkTests : IDisposable
	{
	    ...
	    static IList<DynamicTableEntity> TableQueryTakeDynamic(CloudTable table, int takeCount)
	    {
            var queryToken = new TableContinuationToken();
            var executeTask = table.ExecuteQuerySegmentedAsync(new TableQuery().Take(takeCount), queryToken);
	        return executeTask.Result.Results;
	    }

	    const int WaitTimeoutMilliseconds = 2000;
		...
		public void WhenALoggerWritesToTheSinkItIsRetrievableFromTheTableWithProperties()
		{
			...
			table.DeleteIfExistsAsync().Wait(WaitTimeoutMilliseconds);
		    ...
		    var result = TableQueryTakeDynamic(table, takeCount: 1).First();
        ...
        public void WhenABatchLoggerWritesToTheSinkItStoresAllTheEntries()
		{
            ...
            var result = TableQueryTakeDynamic(table, takeCount: 11);
        ...
        public void WhenABatchLoggerWritesToTheSinkItStoresAllTheEntriesInDifferentPartitions()
		{
            ...
            var result = TableQueryTakeDynamic(table, takeCount: 9);
        ...
        public void WhenABatchLoggerWritesToTheSinkItStoresAllTheEntriesInLargeNumber()
		{
            ...
            var result = TableQueryTakeDynamic(table, takeCount: 301);
