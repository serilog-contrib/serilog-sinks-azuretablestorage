...
{
    [Collection("AzureStorageCloudTableIntegrationTests")]
    public class AzureTableStorageWithPropertiesSinkCloudTableTests
    {
        ...
        public async Task WhenALoggerWritesToTheSinkItIsRetrievableFromTheTableWithProperties()
        {
            ...
            var logger = new LoggerConfiguration()
                .WriteTo.AzureTableStorageWithProperties(table)
                .CreateLogger();
